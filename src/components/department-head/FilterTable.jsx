...
const FilterTable = () => {
  ...
  const initialData = [
    { id: 1, mssv: 'SP-51252', name: 'Phan Văn B', dob: '02/06/2001', score: 9.9, status: 'Đang đi học', course: 'Khóa 2024', class: 'Lớp A', year: '2024 - 2025', semester: 'Học Kỳ 1' },
    { id: 2, mssv: 'SP-51253', name: 'Nguyễn Thị A', dob: '05/08/2000', score: 8.5, status: 'Nghỉ học', course: 'Khóa 2024', class: 'Lớp B', year: '2024 - 2025', semester: 'Học Kỳ 1' },
    { id: 3, mssv: 'SP-51254', name: 'Trần Minh C', dob: '12/01/1999', score: 7.8, status: 'Tạm hoãn', course: 'Khóa 2025', class: 'Lớp C', year: '2025 - 2026', semester: 'Học Kỳ 2' },
    { id: 4, mssv: 'SP-51255', name: 'Lê Quang D', dob: '20/02/2000', score: 8.3, status: 'Đang đi học', course: 'Khóa 2025', class: 'Lớp A', year: '2024 - 2025', semester: 'Học Kỳ 2' },
    { id: 5, mssv: 'SP-51256', name: 'Hoàng Thanh E', dob: '10/05/2001', score: 9.4, status: 'Đình chỉ', course: 'Khóa 2025', class: 'Lớp B', year: '2025 - 2026', semester: 'Học Kỳ 3' },
      ...
      <div className="p-4 bg-white border-b">
        <div className="flex justify-between mb-4">
          <div className="flex space-x-4">
            <input className="border p-2 rounded" placeholder="MSSV" type="text" />
            <input className="border p-2 rounded" placeholder="Tên" type="text" />
